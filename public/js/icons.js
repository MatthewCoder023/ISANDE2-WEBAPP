/**
 * Inline SVG icon set (outline style, from Lucide — ISC licensed).
 * Kept local so the app has no CDN dependency and dynamically rendered
 * markup can interpolate icons directly.
 *
 * Usage:
 *   icon('package')                        -> svg string
 *   <span data-icon="package"></span>      -> filled in by hydrateIcons()
 */
const ICONS = {
  ...
  peso: '<path d="M20 11H4"/><path d="M20 7H4"/><path d="M7 21V4a1 1 0 0 1 1-1h4a1 1 0 0 1 0 12H7"/>',
  ...
  'arrow-left': '<path d="M15 7L8 12L15 17"/>',
  download:
...
/**
 * Fills every <span data-icon="name" data-icon-size="20"> in static
 * markup with its SVG. Safe to call more than once.
 */
